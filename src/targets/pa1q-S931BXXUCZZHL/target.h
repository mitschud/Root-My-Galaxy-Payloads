...
/*
 * SM-S931B / S931BXXUCZZHL (Galaxy S25, Snapdragon 8 Elite, pa1q).
 * Kernel release: 6.6.127-android15-8-paa4b906-abogkiS931BXXUCZZHL-4k
 * Android 17 (SDK 37), build ID CP2A.260605.016, SPL 2026-08-05.
 * All *_OFF values are offsets from KIMAGE_TEXT_BASE and were recovered
 * from this exact kernel Image (vmlinux-to-elf base 0xffffffc080000000)
 * and its BTF; struct-layout macros were verified against the target BTF.
 */

#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define BUILD_VARIANT_LABEL "pa1q-S931BXXUCZZHL-app-physical-p0-oracle"
...
#else
#define BUILD_VARIANT_LABEL "pa1q-S931BXXUCZZHL-root-umh"
#endif
#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/pa1qxxx/pa1q:17/CP2A.260605.016/S931BXXUCZZHL:user/release-keys"
#endif
...
/* Offline derivation: (__event_sched_blocked_reason - __start_ftrace_events)
 * / 8 = 89; with the 6.6 GKI __TRACE_LAST_TYPE = 20 the runtime ID is 109.
 * Verify on device via
...
#define P0_FINGERPRINT_HEADER \
  "targets/pa1q-S931BXXUCZZHL/p0_fingerprint.h"
#endif
...
#define ASHMEM_COMPAT_IOCTL_OFF 0x00d7ee00ULL
...
/* 6.6 removed generic_file_splice_read; copy_splice_read fills the same
 * fake-fops splice_read slot on this kernel. */
...
/* selinux_state.enforcing; BTF: offsetof(struct selinux_state, enforcing)=0 */
